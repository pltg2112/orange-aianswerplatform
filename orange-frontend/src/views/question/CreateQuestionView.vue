    ...
    >
      ...
      <a-form-item label="题目列表" :content-flex="false" :merge-props="false">
        ...
        <div v-for="(question, index) in questionContent" :key="index">
          <a-space size="large">
            <h3>题目 {{ index + 1 }}</h3>
            <a-button @click="addQuestion(index + 1)">
              添加题目
            </a-button>
            <a-button
              size="small"
          ...
          <a-form-item field="posts.post1" label="题目标题">
          ...
          <a-space>
            ...
            <a-button
              size="small"
              @click="addQuestionOption(question, question.options?.length as number)"
            >
              末尾添加选项
            </a-button>
          </a-space>
          ...
          >
            <a-form-item label="key">
              <a-input v-model="option.key" placeholder="请输入key" />
            </a-form-item>
            <a-form-item label="值">
